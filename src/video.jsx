...
class VideoPage extends basePage {
  constructor(props) {
    ...
    this.state = {
      ...
      mediaDestination: this.props.mediaDestination || '',
    ...
    fetch(`/api/approot`, { headers: { Authorization: `Bearer ${this.state.token}` } })
      ...
      .then(data => {
        this.setState({
          ...
          mediaDestination: this.state.mediaDestination || ''
        });
      })
...
componentWillUnmount() {
  ...
  handleMediaDestinationChange = (event) => {
    // Update media destination path (used for both photos and videos)
    this.setState({ mediaDestination: event.target.value });
  }
          ...
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>
              ...
              <div style={{ display: showVideoSettings ? 'block' : 'none' }}>
                ...
                {/* Media Destination (single folder for photos and videos) */}
                {isVideo && (
                  <div className="form-group row" style={{ marginBottom: '5px' }}>
                    ...
                    <div className="col-sm-8">
                      <Form.Control 
                        disabled={active} 
                        type="text" 
                        onChange={this.handleMediaDestinationChange} 
                        value={this.state.mediaDestination}
              ...
              <div style={{ display: showPhotoSettings ? 'block' : 'none' }}>
                <div className="form-group row" style={{ marginBottom: '5px' }}>
                  ...
                  <div className="col-sm-8">
                    <Form.Select disabled={active} onChange={this.handleStillDeviceChange} value={this.state.stillDeviceSelected}>
