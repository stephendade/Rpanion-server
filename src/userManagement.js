...
class userManagement extends basePage {
    ...
    renderContent () {
        ...
        <div>
            ...
            <td>{user.username}</td>
            <td>
            <Button variant="danger" onClick={() => this.handleShowModal('deleteUser', user.username)}>Delete</Button>
            <Button variant="primary" onClick={() => this.handleShowModal('changePassword', user.username)}>Change Password</Button>
            </td>
            </tr>
            ))}
            </tbody>
            ...
            <Button variant="success" onClick={() => this.handleShowModal('addUser')}>Add New User</Button>
            ...
            <Button variant="primary" onClick={this.handleSubmit} disabled={!isFormValid}>Save Changes</Button>
            </Modal.Footer>
            </Modal>
        </div>
        )
