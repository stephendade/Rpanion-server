...
function editConnectionPSK(conName, conSettings, callback) {
    ...
    if (conSettings.mode.value === "infrastructure" || conSettings.mode.value === "ap" || conSettings.mode.value === "adhoc") {
        //psk network
...
function editConnectionAP(conName, conSettings, callback) {
    ...
    if (conSettings.mode.value === "ap" || conSettings.mode.value === "adhoc") {
